...
PM_START_TEXT = """
**Hello {}, My Name is {}!** 
I am an **DARK FOX**  group management bot.
...
TECHNO_IMG = "https://telegra.ph/file/77870ac2960e6c9cbc53c.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Yuss, I am Already ONline 24 Hours 😎😎")
